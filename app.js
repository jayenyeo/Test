...
const QUESTIONS = [
  // A 정량
  { id:"A1", dim:"quant", prompt:"(학습) 문제에 조건이 많다. 이때 나는?", choices:[
    "숫자는 부담돼서 말로 정리된 설명이 더 좋다",
    "숫자는 참고만 하고 전체 흐름 위주로 본다",
    "핵심 숫자 몇 개를 정리해 보며 이해한다",
    "조건을 수치로 정리해야 명확해진다"
  ]},
  { id:"A2", dim:"quant", prompt:"(학습) 비율·증감·수치 비교가 나오면?", choices:[
    "설명이 어려워져서 이해가 느려진다",
    "말로 다시 풀어주면 이해가 된다",
    "수치가 있어서 오히려 이해가 잘 된다",
    "수치 관계가 핵심이라고 느낀다"
  ]},
  { id:"A3", dim:"quant", prompt:"(일상) 선택지를 비교할 때(가격·시간·효율 등) 나는?", choices:[
    "감으로 고른다",
    "대략 유리해 보이는 걸 고른다",
    "몇 가지 기준을 수치로 비교한다",
    "가능한 한 정량적으로 비교한다"
  ]},
  { id:"A4", dim:"quant", prompt:"(학습) 풀이 과정에 계산이 포함된 문제를 보면?", choices:[
    "계산 때문에 아예 손이 안 간다",
    "계산이 많으면 피하고 싶다",
    "계산이 있어도 원리가 보이면 괜찮다",
    "계산이 있어야 오히려 확신이 든다"
  ...
  // B 이론
  { id:"B1", dim:"theory", prompt:"(학습) 새 개념을 배울 때 나는?", choices:[
    "결과만 알면 된다",
    "예시를 통해 익히면 충분하다",
    "왜 그렇게 되는지 궁금해진다",
    "원리→적용 구조가 보여야 이해된다"
  ]},
  { id:"B2", dim:"theory", prompt:"(학습) 여러 개념이 한 단원에 등장할 때 나는?", choices:[
    "각각 따로 외운다",
    "비슷한 것만 묶어서 본다",
    "개념 간 연결을 의식하며 정리한다",
    "전체 구조를 먼저 잡고 들어간다"
  ]},
  { id:"B3", dim:"theory", prompt:"(일상) 누군가 현상을 설명할 때 나는?", choices:[
    "결과만 들으면 된다",
    "자세한 설명은 지루하다",
    "이유가 있으면 더 이해된다",
    "논리 흐름이 맞아야 납득된다"
  ]},
  { id:"B4", dim:"theory", prompt:"(학습) 문제를 틀렸을 때 나는?", choices:[
    "정답만 확인한다",
    "풀이를 한 번 읽어본다",
    "왜 틀렸는지 원인을 찾는다",
    "개념 구조에서 어디가 흔들렸는지 점검한다"
  ]},
  ...
  { id:"C3", dim:"memory", prompt:"(일상) 설명/안내가 길 때 나는?", choices:[
    "잘 기억하지 못한다",
    "필요한 부분만 기억한다",
    "메모하거나 정리해서 기억한다",
    "정리하면 웬만한 건 기억한다"
  ...
  // D 자료
  { id:"D1", dim:"data", prompt:"(학습) 표·그래프가 포함된 문제가 나오면 나는?", choices:[
    "글 설명부터 본다",
    "그래프는 참고만 한다",
    "그래프를 보며 흐름을 파악한다",
    "그래프가 핵심이라고 느낀다"
  ...
  { id:"D3", dim:"data", prompt:"(일상) 지도·도표·설명서를 볼 때 나는?", choices:[
    "말로 설명받는 게 편하다",
    "그림은 참고만 한다",
    "자료를 보며 이해한다",
    "자료가 있어야 정확히 이해된다"
  ...
  { id:"E3", dim:"judgment", prompt:"(일상) 의견이 갈리는 주제에 대해 나는?", choices:[
    "빨리 결론이 나야 편하다",
    "다수 의견을 따른다",
    "이유를 듣고 판단한다",
    "기준을 세워 스스로 판단한다"
...
function renderResult(studentV, top3){
  ...
  elGuide.innerHTML = `강점 축: <b>${highs}</b><br/>보완하면 좋은 축: <b>${lows}</b><br/><span class="small">※ 적합도는 과목 요구 패턴과의 닮은 정도(코사인)입니다.</span>`;
